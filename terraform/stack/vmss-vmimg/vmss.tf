terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "azu-lnadoresd01"
    storage_account_name = "lnosadostblobvmssimgdev"
    container_name       = "statefiles"
    key                  = "vmssimg.terraform.tfstate"
  }
}
...
#   name                = var.main_virtual_machine_image_name
#   resource_group_name = var.main_virtual_machine_image_resource_group_name
# }
...
module "virtual_machine_scale_set" {
  ...
  source_image_id                 = var.main_virtual_machine_image_id
